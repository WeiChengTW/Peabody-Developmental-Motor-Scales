...
const TASK_MAP = {
  ...
  "ch3-t2": { emoji:"📐", title:"剪方：做方方正正的門",
    ...
    "ch3-t3": { emoji:"📐", title:"延直線剪：把窗戶剪開",
    desc:"幫小精靈把剛剛的窗戶延線剪開。",
    img:"/video/ch3-t4.mp4",
    steps:[ "沿著畫好的直線慢慢剪", "剪的線要直", "剪完後檢查是否平整" ]
  },
    "ch3-t4": { emoji:"✂️", title:"平分紙張：剪窗簾",
    desc:"幫小精靈的窗戶剪出一個窗簾。",
    img:"/video/ch3-t3.mp4",
    steps:[ "根據給的紙，平分成兩半", "要注意剪的位置", "剪完的紙大小要一樣" ]
  },
