...
def draw_block_markers(frame, boxes, masks, is_correct):
    ...
    # 確保 frame 是彩色 (BGR) 圖像，如果傳入的是二值圖則需要轉換
    ...
    for i, box in enumerate(boxes):
        ...
        # 繪製中心點 (圓形)
        cv2.circle(frame_display, center, radius=10, color=color, thickness=-1)
