...
class ScreenCapture:
    ...
    def find_next_index(self):
        """找到下一個可用的檔案索引"""
        while os.path.exists(f"paper2/test_img/img{self.index}.jpg"):
            self.index += 1
        return self.index
    ...
    def save_frame(self, frame):
        ...
        filename = f"paper2/test_img/img{index}.jpg"
    ...
    def run(self):
        ...
        while True:
            ...
            # 顯示畫面
            cv2.imshow("Camera - Press ENTER to save, Q to quit", frame)
