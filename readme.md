...
**團隊名稱：** 獵遲者  
**比賽：** 2025 中華電信數位創新應用系列賽 - 5G 創新應用大賽  
**日期：** 中華民國 114 年 9 月 16 日
...
- **攝影機：** PW313D 雙鏡頭網路攝影機
- **其他裝置：**
  - 觸控螢幕 (Anmite 14 寸 IPS 薄款 1080P-60HZ 帶觸摸)
  - 螢幕、鍵盤、滑鼠
...
- **發展軟體環境：** Windows 11
- **使用軟體環境：** Windows 11
- **程式語言：** Python 3.7/3.10/3.13、HTML、CSS、JavaScript、MySQL 於開發一套基於 AI 技術的兒童精細動作檢測系統，針對 4-6 歲兒童設計，透過遊戲化故事情境與標準化評估流程，協助偏鄉地區早期發現兒童發展遲緩問題。系統以 PDMS-2 量表為基礎，結合影像辨識與機器學習技術，提供可攜式、低門檻的篩檢工具。

### 技術棧

- **程式語言：** Python 3.7/3.10/3.13、HTML、CSS、JavaScript
- **資料庫：** MySQL
- **AI 框架：** YOLOv8、YOLOv11（物件偵測）
- **硬體：** 雙鏡頭攝影機、觸控螢幕、可攜式帳篷環境
