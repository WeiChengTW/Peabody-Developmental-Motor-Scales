...
if __name__ == "__main__":
    ...
    img_mode = "image"  # 'PrtSc' or 'image' or 'dir'
    ...
    if img_mode == "dir":
        ...
        for img in image_files:
            ...
            if detector_image_path is not None:
                # print("\n開始圖形分析...")

                segmenter = Analyze_graphics()
                # segmenter.reset_dir()
                segmenter.infer_and_draw(
                    image_path=detector_image_path, thresh_path=thresh_img_path
                )
    else:
        if img_mode == "PrtSc":
            print("開始截圖...")
            ...
            img = "img3.jpg"
            image_path = r"C:\Users\hiimd\Desktop\vscode\Peabody-Developmental-Motor-Scales\draw_circle\circle2\graph_yolov8\S__10280963.jpg"
