...
x_range = 7  # 判斷 head 中心在 body 哪個邊附近的範圍
y_range = 13  # 判斷 head 中心在 body 哪個邊
...
while True:
    ...
    if zip_body_box and zip_head_box:
        ...
        # 側面判斷：head 靠近 body 上緣為拉上，靠近下緣為拉開
        if abs(head_center_y - body_y1) < y_range:
            current_state = "pull"  # 上緣
        elif abs(head_center_y - body_y2) < y_range:
            current_state = "release"  # 下緣
        else:
            current_state = None
