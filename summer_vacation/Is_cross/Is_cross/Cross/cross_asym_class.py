...
class AsymmetryDetector:
    def __init__(self, threshold=0.27):
    ...
    def detect(self, img_path, debug=True, scale=3):
        ...
        if debug:
            ...
            print("判斷：", "非對稱" if asym_score > self.threshold else "對稱")
            def resize(img):
        ...
        return asym_score > self.threshold

if __name__ == "__main__":
    src_folder = "test"
    extensions = ('.jpg', '.jpeg', '.png')
    detector = AsymmetryDetector(threshold=0.27)
