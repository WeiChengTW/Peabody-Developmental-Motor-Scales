...
class PaperDetector_edges:
    ...
    def extract_paper_region(self):
        ...
        # 往外擴展10像素
        padding = 10
        expanded_width = max_width + 2 * padding
        expanded_height = max_height + 2 * padding
        ...
        warped = cv2.warpPerspective(image, matrix, (expanded_width, expanded_height))
